...
$class_level = isset($_GET['level']) ? ucfirst($_GET['level']) : "Advanced";
...
<div class="container">
    <div class="header">
        ...
        <div class="nav-menu">
            <a href="chat.php" class="nav-item active"><i class="fas fa-clipboard-list"></i> Chat</a>
            <a href="quiz.php" class="nav-item"><i class="fas fa-clipboard-list"></i> QUIZ</a>
            <a href="dashboard.php" class="nav-item"><i class="fas fa-user"></i> PROFILE</a>
        </div>
        <div class="user-info"><?php echo $username; ?> (Teacher)</div>
    </div>
